...
namespace traobang.be.infrastructure.data.Migrations
{
    ...
    [Migration("20260105083230_update-tbl-tien-dotraobang")]
    partial class updatetbltiendotraobang
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("traobang.be.domain.Auth.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("traobang.be.domain.TraoBang.DanhSachSinhVienNhanBang", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("traobang.be.domain.TraoBang.GiaoDien", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Id" }, "IX_GiaoDien");

                    b.ToTable("GiaoDien", "tb");
                });

            modelBuilder.Entity("traobang.be.domain.TraoBang.Plan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdGiaoDien");

                    b.HasIndex(new[] { "Id" }, "IX_Plan");

                    b.ToTable("Plan", "tb");
                });

            modelBuilder.Entity("traobang.be.domain.TraoBang.Slide", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Id" }, "IX_Slide");

                    b.ToTable("Slide", "tb");
                });

            modelBuilder.Entity("traobang.be.domain.TraoBang.SubPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsShowKetBai")
                        .HasColumnType("bit");

                    b.Property<bool>("IsShowMoBai")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("KetBaiNote")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MoBai")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MoBaiNote")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("traobang.be.domain.TraoBang.TienDoTraoBang", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("TrackingDangTrao")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex(new[] { "Id" }, "IX_TienDoTraoBang");

                    b.ToTable("TienDoTraoBang", "tb");
                });

            modelBuilder.Entity("traobang.be.domain.TraoBang.TraoBangLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("traobang.be.domain.Auth.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("traobang.be.domain.TraoBang.Plan", b =>
                {
                    b.HasOne("traobang.be.domain.TraoBang.GiaoDien", "GiaoDien")
                        .WithMany("Plans")
                        .HasForeignKey("IdGiaoDien")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("GiaoDien");
                });
