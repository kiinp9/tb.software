            ...
            <div class="flex flex-col items-center justify-center">
                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, color-mix(in srgb, var(--primary-color), transparent 60%) 10%, var(--surface-ground) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                        ...
                        <!-- <div class="text-surface-600 dark:text-surface-200 mb-8">Tính năng đang được nâng cấp. Vui lòng liên hệ Admin để nhận thêm thông tin chi tiết.</div> -->
                        <h1 class="text-surface-900 dark:text-surface-0 font-bold text-xl lg:text-2xl mb-8 text-center leading-relaxed">
                            TÀI KHOẢN CỦA BẠN CHƯA ĐƯỢC PHÂN QUYỀN,<br/>
                            LIÊN HỆ TTCNTT ĐỂ ĐƯỢC CẬP NHẬT
                        </h1>
